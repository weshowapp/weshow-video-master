...
def main():
    ...
    url_list = soupBox.find_all('div', class_="ritext")
    if url_list:
        print(len(url_list))
        #print(url_list[0])
        ...
        try:
            ...
            for urlitem in url_list:
                ...
                article_author = soup.find('span', class_="item")
                if article_author:
                    arr = article_author.text.split( )
                    if (len(arr) > 2):
                        author = arr[0]
                    author = author.strip("\n")
                    author = author.strip()
                ...
                #time
                article_time = soup.find('span', class_="item")
                print ('article_time')
                print (article_time)
                if article_time:
