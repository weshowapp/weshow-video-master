...
export default class extends think.model.base {
  ...
  async createCalculateGainEvent(quizid, interval) {
    ...
    var sqlProc = ' '
        ...
        + '    CLOSE cur;'
        + '    END; '
        + '    SELECT balance,relive INTO var_balance,var_relive FROM ' + tableUser + ' WHERE openid=var_creator_id; '
        + '    SET var_balance = var_balance - var_price; '
        + '    SET var_relive = var_relive + 1; '
        + '    UPDATE ' + tableUser + ' SET balance=var_balance,relive=var_relive WHERE openid=var_creator_id; '
